...
const GroupsPage = () => {
    ...
    return (_jsxs("div", { className: "flex h-screen bg-gray-100 font-lato", children: [_jsx(Sidebar, {}), _jsxs("main", { className: "flex-1 flex flex-col overflow-hidden", children: [_jsxs("header", { className: "bg-white border-b border-gray-200 p-6 flex justify-between items-center", children: [_jsx("h1", { className: "font-poppins text-3xl font-bold", children: "Groups" }), _jsxs(motion.button, { onClick: () => setIsModalOpen(true), whileHover: { scale: 1.05 }, whileTap: { scale: 0.95 }, className: "flex items-center gap-2 bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md hover:bg-blue-700", children: [_jsx(Plus, { size: 20 }), "Create Group"] })] }), _jsx(motion.div, { variants: containerVariants, initial: "hidden", animate: "visible", className: "flex-1 overflow-y-auto p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8", children: mockGroups.map(group => (_jsx(GroupCard, { group: group }, group.id))) })] }), _jsx(AnimatePresence, { children: isModalOpen && _jsx(CreateGroupModal, { onClose: () => setIsModalOpen(false) }) })] }));
};
