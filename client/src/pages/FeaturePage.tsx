...
import { 
    MessageSquare, FolderUp, BellRing, Users, Code, Activity,
...
const FeaturesPage: React.FC = () => {
  return (
    <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="bg-gray-50 font-lato text-gray-800"
    >
        <Header />

        {/* Hero Section */}
       <header className="bg-gradient-to-br from-blue-600 via-cyan-400 to-purple-500 py-24 sm:py-32 text-center">
            <motion.div
            ...
            >
                <h1 className="font-poppins text-5xl md:text-6xl font-bold tracking-tight mb-4 text-white"> {/* <-- text-white here */}
                    Powerful by Design
                </h1>
                <p className="text-lg text-blue-100 max-w-3xl mx-auto"> {/* <-- text-blue-100 for lighter contrast */}
                    Explore the comprehensive suite of features that make ConnectSphere the most intuitive and robust communication platform for modern teams.
                </p>
            </motion.div>
        </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {allFeatures.map((feature, index) => (
                    <motion.div
                        ...
                        className="bg-white p-8 rounded-2xl border border-gray-100 h-full flex flex-col cursor-pointer"
                    >
                        <div className="bg-blue-100 p-3 rounded-xl inline-block mb-5">
